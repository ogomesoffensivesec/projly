  ...
  return (
    ...
    >
      <div
        data-slot="stepper"
        className={cn(
          "group/stepper w-full inline-flex justify-between data-[orientation=horizontal]:flex-row data-[orientation=vertical]:flex-col",
          className
        )}
  ...
  return (
    ...
    >
      <div
        ...
        className={cn(
          "group/step w-full flex items-center justify-center group-data-[orientation=horizontal]/stepper:flex-row group-data-[orientation=vertical]/stepper:flex-col",
          className
        )}
        data-state={state}
...
function StepperTrigger({
  ...
  return (
    <button
      ...
      className={cn(
        "focus-visible:border-ring focus-visible:ring-ring/50 inline-flex items-center justify-center gap-3 rounded-full outline-none focus-visible:z-10 focus-visible:ring-[3px] disabled:pointer-events-none disabled:opacity-50",
        className
      )}
